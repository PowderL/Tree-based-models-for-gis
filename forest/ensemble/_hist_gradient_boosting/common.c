...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "forest.ensemble._hist_gradient_boosting.common",
        "sources": [
            "forest\\ensemble\\_hist_gradient_boosting\\common.pyx"
        ]
    },
    "module_name": "forest.ensemble._hist_gradient_boosting.common"
}
END: Cython Metadata */
...
#define __PYX_HAVE__forest__ensemble___hist_gradient_boosting__common
#define __PYX_HAVE_API__forest__ensemble___hist_gradient_boosting__common
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* "forest/ensemble/_hist_gradient_boosting/common.pxd":8
 * 
 * 
...
/* "forest/ensemble/_hist_gradient_boosting/common.pxd":9
 * 
 * ctypedef np.npy_float64 X_DTYPE_C
 * ctypedef np.npy_uint8 X_BINNED_DTYPE_C             # <<<<<<<<<<<<<<
 * ctypedef np.npy_float64 Y_DTYPE_C
...
/* "forest/ensemble/_hist_gradient_boosting/common.pxd":10
 * ctypedef np.npy_float64 X_DTYPE_C
 * ctypedef np.npy_uint8 X_BINNED_DTYPE_C
 * ctypedef np.npy_float64 Y_DTYPE_C             # <<<<<<<<<<<<<<
 * ctypedef np.npy_float32 G_H_DTYPE_C
...
/* "forest/ensemble/_hist_gradient_boosting/common.pxd":11
 * ctypedef np.npy_uint8 X_BINNED_DTYPE_C
 * ctypedef np.npy_float64 Y_DTYPE_C
 * ctypedef np.npy_float32 G_H_DTYPE_C             # <<<<<<<<<<<<<<
 * 
...
/* "forest/ensemble/_hist_gradient_boosting/common.pxd":37
 * 
 * 
...
/* "forest/ensemble/_hist_gradient_boosting/common.pxd":13
 * ctypedef np.npy_float32 G_H_DTYPE_C
 * 
 * cdef packed struct hist_struct:             # <<<<<<<<<<<<<<
...
/* "forest/ensemble/_hist_gradient_boosting/common.pxd":21
 * 
 * 
...
/* CIntToPy.proto */
static CYTHON_INLINE PyObject* __Pyx_PyInt_From_enum____pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint(enum __pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint value);
...
#define __Pyx_MODULE_NAME "forest.ensemble._hist_gradient_boosting.common"
extern int __pyx_module_is_main_forest__ensemble___hist_gradient_boosting__common;
int __pyx_module_is_main_forest__ensemble___hist_gradient_boosting__common = 0;

/* Implementation of 'forest.ensemble._hist_gradient_boosting.common' */
...
static PyTypeObject __Pyx_EnumMeta = {
  ...
  "forest.ensemble._hist_gradient_boosting.common.__Pyx_EnumMeta", /*tp_name*/
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_forest__ensemble___hist_gradient_boosting__common) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "forest.ensemble._hist_gradient_boosting.common")) {
      if (unlikely(PyDict_SetItemString(modules, "forest.ensemble._hist_gradient_boosting.common", __pyx_m) < 0)) __PYX_ERR(2, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":6
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":7
 * # and hessians arrays are stored as floats to avoid using too much memory.
 * Y_DTYPE = np.float64
 * X_DTYPE = np.float64             # <<<<<<<<<<<<<<
 * X_BINNED_DTYPE = np.uint8  # hence max_bins == 256
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":8
 * Y_DTYPE = np.float64
 * X_DTYPE = np.float64
 * X_BINNED_DTYPE = np.uint8  # hence max_bins == 256             # <<<<<<<<<<<<<<
 * # dtype for gradients and hessians arrays
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":10
 * X_BINNED_DTYPE = np.uint8  # hence max_bins == 256
 * # dtype for gradients and hessians arrays
 * G_H_DTYPE = np.float32             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":13
 * 
 * HISTOGRAM_DTYPE = np.dtype([
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":14
 * HISTOGRAM_DTYPE = np.dtype([
 *     ('sum_gradients', Y_DTYPE),  # sum of sample gradients in bin
 *     ('sum_hessians', Y_DTYPE),  # sum of sample hessians in bin             # <<<<<<<<<<<<<<
 *     ('count', np.uint32),  # number of samples in bin
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":15
 *     ('sum_gradients', Y_DTYPE),  # sum of sample gradients in bin
 *     ('sum_hessians', Y_DTYPE),  # sum of sample hessians in bin
 *     ('count', np.uint32),  # number of samples in bin             # <<<<<<<<<<<<<<
 * ])
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":12
 * G_H_DTYPE = np.float32
 * 
 * HISTOGRAM_DTYPE = np.dtype([             # <<<<<<<<<<<<<<
 *     ('sum_gradients', Y_DTYPE),  # sum of sample gradients in bin
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":19
 * 
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":20
 * PREDICTOR_RECORD_DTYPE = np.dtype([
 *     ('value', Y_DTYPE),
 *     ('count', np.uint32),             # <<<<<<<<<<<<<<
 *     ('feature_idx', np.uint32),
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":21
 *     ('value', Y_DTYPE),
 *     ('count', np.uint32),
 *     ('feature_idx', np.uint32),             # <<<<<<<<<<<<<<
 *     ('threshold', X_DTYPE),
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":22
 *     ('count', np.uint32),
 *     ('feature_idx', np.uint32),
 *     ('threshold', X_DTYPE),             # <<<<<<<<<<<<<<
 *     ('missing_go_to_left', np.uint8),
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":23
 *     ('feature_idx', np.uint32),
 *     ('threshold', X_DTYPE),
 *     ('missing_go_to_left', np.uint8),             # <<<<<<<<<<<<<<
 *     ('left', np.uint32),
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":24
 *     ('threshold', X_DTYPE),
 *     ('missing_go_to_left', np.uint8),
 *     ('left', np.uint32),             # <<<<<<<<<<<<<<
 *     ('right', np.uint32),
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":25
 *     ('missing_go_to_left', np.uint8),
 *     ('left', np.uint32),
 *     ('right', np.uint32),             # <<<<<<<<<<<<<<
 *     ('gain', Y_DTYPE),
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":26
 *     ('left', np.uint32),
 *     ('right', np.uint32),
 *     ('gain', Y_DTYPE),             # <<<<<<<<<<<<<<
 *     ('depth', np.uint32),
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":27
 *     ('right', np.uint32),
 *     ('gain', Y_DTYPE),
 *     ('depth', np.uint32),             # <<<<<<<<<<<<<<
 *     ('is_leaf', np.uint8),
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":28
 *     ('gain', Y_DTYPE),
 *     ('depth', np.uint32),
 *     ('is_leaf', np.uint8),             # <<<<<<<<<<<<<<
 *     ('bin_threshold', X_BINNED_DTYPE),
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":29
 *     ('depth', np.uint32),
 *     ('is_leaf', np.uint8),
 *     ('bin_threshold', X_BINNED_DTYPE),             # <<<<<<<<<<<<<<
 * ])
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":18
 * ])
 * 
 * PREDICTOR_RECORD_DTYPE = np.dtype([             # <<<<<<<<<<<<<<
 *     ('value', Y_DTYPE),
 ...
 */
  ...
  /* "forest/ensemble/_hist_gradient_boosting/common.pyx":32
 * ])
 * 
 ...
 *             if v == value:
 */
  __pyx_t_8 = __Pyx_CyFunction_New(&__pyx_mdef_8EnumBase_14__Pyx_EnumBase_1__new__, __Pyx_CYFUNCTION_STATICMETHOD, __pyx_n_s_Pyx_EnumBase___new, NULL, __pyx_n_s_EnumBase, __pyx_d, ((PyObject *)__pyx_codeobj__4)); if (unlikely(!__pyx_t_8)) __PYX_ERR(1, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
 ...
 *     def __str__(self):
 */
  __pyx_t_8 = __Pyx_CyFunction_New(&__pyx_mdef_8EnumBase_14__Pyx_EnumBase_3__repr__, 0, __pyx_n_s_Pyx_EnumBase___repr, NULL, __pyx_n_s_EnumBase, __pyx_d, ((PyObject *)__pyx_codeobj__7)); if (unlikely(!__pyx_t_8)) __PYX_ERR(1, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
 ...
 * 
 */
  __pyx_t_8 = __Pyx_CyFunction_New(&__pyx_mdef_8EnumBase_14__Pyx_EnumBase_5__str__, 0, __pyx_n_s_Pyx_EnumBase___str, NULL, __pyx_n_s_EnumBase, __pyx_d, ((PyObject *)__pyx_codeobj__9)); if (unlikely(!__pyx_t_8)) __PYX_ERR(1, 41, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
 ...
 *         ('NEG', NEG),
 */
    __pyx_t_12 = __Pyx_PyInt_From_enum____pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint(__pyx_e_6forest_8ensemble_23_hist_gradient_boosting_6common_NO_CST); if (unlikely(!__pyx_t_12)) __PYX_ERR(1, 54, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
 ...
 *     ]))
 */
    __pyx_t_12 = __Pyx_PyInt_From_enum____pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint(__pyx_e_6forest_8ensemble_23_hist_gradient_boosting_6common_POS); if (unlikely(!__pyx_t_12)) __PYX_ERR(1, 55, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
 ...
 */
    __pyx_t_12 = __Pyx_PyInt_From_enum____pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint(__pyx_e_6forest_8ensemble_23_hist_gradient_boosting_6common_NEG); if (unlikely(!__pyx_t_12)) __PYX_ERR(1, 56, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_8 = __Pyx_PyInt_From_enum____pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint(__pyx_e_6forest_8ensemble_23_hist_gradient_boosting_6common_NO_CST); if (unlikely(!__pyx_t_8)) __PYX_ERR(1, 64, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_10 = __Pyx_PyInt_From_enum____pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint(__pyx_e_6forest_8ensemble_23_hist_gradient_boosting_6common_POS); if (unlikely(!__pyx_t_10)) __PYX_ERR(1, 65, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_10);
    __pyx_t_12 = __Pyx_PyInt_From_enum____pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint(__pyx_e_6forest_8ensemble_23_hist_gradient_boosting_6common_NEG); if (unlikely(!__pyx_t_12)) __PYX_ERR(1, 66, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init forest.ensemble._hist_gradient_boosting.common", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init forest.ensemble._hist_gradient_boosting.common");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
/* CIntToPy */
static CYTHON_INLINE PyObject* __Pyx_PyInt_From_enum____pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint(enum __pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint value) {
    const enum __pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint neg_one = (enum __pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint) ((enum __pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint) 0 - (enum __pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint) 1), const_zero = (enum __pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint) 0;
    const int is_unsigned = neg_one > const_zero;
    if (is_unsigned) {
        if (sizeof(enum __pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint) < sizeof(long)) {
            return PyInt_FromLong((long) value);
        } else if (sizeof(enum __pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint) <= sizeof(unsigned long)) {
            return PyLong_FromUnsignedLong((unsigned long) value);
#ifdef HAVE_LONG_LONG
        } else if (sizeof(enum __pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint) <= sizeof(unsigned PY_LONG_LONG)) {
            return PyLong_FromUnsignedLongLong((unsigned PY_LONG_LONG) value);
#endif
        }
    } else {
        if (sizeof(enum __pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint) <= sizeof(long)) {
            return PyInt_FromLong((long) value);
#ifdef HAVE_LONG_LONG
        } else if (sizeof(enum __pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint) <= sizeof(PY_LONG_LONG)) {
            return PyLong_FromLongLong((PY_LONG_LONG) value);
#endif
        }
    }
    {
        int one = 1; int little = (int)*(unsigned char *)&one;
        unsigned char *bytes = (unsigned char *)&value;
        return _PyLong_FromByteArray(bytes, sizeof(enum __pyx_t_6forest_8ensemble_23_hist_gradient_boosting_6common_MonotonicConstraint),
                                     little, !is_unsigned);
    }
}
